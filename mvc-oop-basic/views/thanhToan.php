                        ...
                        <div class="order-summary-content">
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        foreach ($chiTietGioHang as $key => $sanPham): ?>
                                            <tr>
                                                <td>
                                                    <a href=""><?= $sanPham['ten_san_pham'] ?> <strong> × <?= $sanPham['so_luong'] ?></strong></a>
                                                </td>
                                                <td>
                                                    <?php
                                                    $tongtien = 0;
                            ...
                            <div class="order-payment-method">
                                <div class="single-payment-method show">
                                    <div class="payment-method-name">
                                        <div class="custom-control custom-radio">
                                            <input type="radio" id="cashon" name="phuong-thuc-thanh-toan_id" value="1" class="custom-control-input" checked />
                                ...
                                <div class="single-payment-method">
                                    <div class="payment-method-name">
                                        <div class="custom-control custom-radio">
                                            <input type="radio" id="directbank" name="phuong-thuc-thanh-toan_id" value="2" class="custom-control-input" />
