                    ...
                    <div class="widget-item">
                        <div class="widget-title">
                            <div class="widget-logo">
                                <a href="index.html">
                                    <img src="assets/img/logo/levano.jpg" width="170px" alt="brand logo">
                                </a>
                            </div>
                        </div>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="copyright-text text-center">
                        <p>&copy; 2025 <b>Bella Belle</b> Made with <i class="fa fa-heart text-danger"></i> by <a href="#"><b>D.Mạnh</b></a></p>
                    </div>
                </div>
            </div>
        </div>
