...
<head>
    ...
    <script data-cfasync="false" nonce="9c6e5ce9-7797-4641-9811-fcccf1928570">
        try {
            (function(w, d) {
                ! function(bH, bI, bJ, bK) {
                    if (bH.zaraz) console.error("zaraz is loaded twice");
                        ...
                        bH.zaraz._v = "5876";
                        bH.zaraz._n = "9c6e5ce9-7797-4641-9811-fcccf1928570";
                        bH.zaraz.q = [];
        ...
        <div class="card card-outline card-primary">
            ...
            <div class="card-body">
                ...
                <?php if (!empty($_SESSION['error'])): ?>
                    ...
                    <?php unset($_SESSION['error']); // 🔥 QUAN TRỌNG 
                    ?>
